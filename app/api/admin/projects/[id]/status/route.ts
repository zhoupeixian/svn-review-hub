...
import { ProjectAdminError, setAdminProjectEnabled } from '@/lib/project-administration';
...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const project = await setAdminProjectEnabled(auth.user, id, await request.json());
