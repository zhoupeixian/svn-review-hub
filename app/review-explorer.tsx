...
type Props = { initialItems: ReviewSummary[]; initialCursor: string | null; initialHasMore: boolean };

export default function ReviewExplorer({ initialItems, initialCursor, initialHasMore }: Props) {
  ...
  async function loadMore() {
    ...
    try {
      const response = await fetch(`/api/reviews?scope=active&cursor=${encodeURIComponent(cursor)}`);
